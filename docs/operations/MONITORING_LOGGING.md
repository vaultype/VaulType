...
func transcribeAudioSegment(_ segment: AudioSegment) async throws -> TranscriptionResult {
    let signpostID = VaultSignpost.whisper.makeSignpostID()
    let state = VaultSignpost.whisper.beginInterval(
        "Transcription",
        id: signpostID,
    ...
    do {
        ...
        VaultSignpost.whisper.endInterval(
            "Transcription",
            state,
...
func emitModelLoadEvent(modelName: String, sizeBytes: Int64) {
    VaultSignpost.modelLoading.emitEvent(
        "ModelLoaded",
...
func trackTranscription(
    ...
    let signpostID = VaultSignpost.whisper.makeSignpostID()
    let state = VaultSignpost.whisper.beginInterval("Transcription", id: signpostID)
    ...
    VaultSignpost.whisper.endInterval("Transcription", state)
...
func trackLLMInference(
    ...
    let signpostID = VaultSignpost.llm.makeSignpostID()
    let state = VaultSignpost.llm.beginInterval("LLMInference", id: signpostID)
    ...
    VaultSignpost.llm.endInterval("LLMInference", state)
...
func trackTextInjection(
    ...
    let signpostID = VaultSignpost.injection.makeSignpostID()
    let state = VaultSignpost.injection.beginInterval("TextInjection", id: signpostID)
    ...
    VaultSignpost.injection.endInterval("TextInjection", state)
...
func trackModelLoad(
    ...
    let signpostID = VaultSignpost.modelLoading.makeSignpostID()
    let state = VaultSignpost.modelLoading.beginInterval("ModelLoad", id: signpostID)
    ...
    VaultSignpost.modelLoading.endInterval("ModelLoad", state)
    VaultSignpost.modelLoading.emitEvent(
        "ModelLoaded",
