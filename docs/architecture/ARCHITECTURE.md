...
VaulType supports voice commands that trigger system actions instead of injecting text. Voice commands are detected by a configurable prefix (default: "hey vault") and parsed into structured actions.
...
actor PluginManager {
    ...
    func discoverPlugins() async throws {
        for path in searchPaths {
            ...
            for item in contents where item.pathExtension == "vaultplugin" {
